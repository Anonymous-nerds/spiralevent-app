...
const EditEvent = () => {
  ...
  return (
    <div className="EditEvent min-h-screen bg-gradient-to-br from-pink-50 to-white">
      <Nav />
      <div className="container mx-auto px-4 py-3">
        <div className="max-w-4xl mx-auto overflow-hidden shadow-sm rounded-xl">
          <div className="p-6 md:p-8">
            ...
            {/* Title Banner */}
            <div className="title">
              <h2 className="text-2xl md:text-3xl font-bold text-white text-center">Edit Event</h2>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div className="flex flex-col items-center gap-4 mt-8">
                <button type="submit" className="submitBtn">Update Event</button>
