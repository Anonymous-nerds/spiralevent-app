...
const ForgetPassword = () => {
  return (
    <div className='container main flex justify-center h-[min-100vh] w-full p-20 '>
      ...
      <div>
        <label htmlFor="email" className='flex pt-5'>Email</label>
        <input  type="text"
                  id="email"
                  name="email"
      ...
      <button className='w-full px-8 py-3 bg-pink-800 rounded-md text-white font-semibold hover:bg-pink-700'>Reset Password</button>
      </div>
